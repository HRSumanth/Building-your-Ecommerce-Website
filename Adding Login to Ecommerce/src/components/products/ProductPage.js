...
const product ={...selectedItem[0],reviews:[{author:'Sam',content:'Lorem ipsum carrots enhanced rebates.'}]}
      ...
      <div className="product-images">
        <ul className="images-list">
          {productImages.map((image, index) => (
            <li>
             <img key={index} src={image.url} alt={image.alt} onClick={()=>changeImageHandler(image.url)} />
            </li>  
          ))}
        </ul>
