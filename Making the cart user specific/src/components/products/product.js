...
const Products=({product})=>{
  ...
  const { addItem,selectedItemHandler } = useContext(CartContext);
  ...
  const addCartItem = () => {
    const newItem ={...product,amount:parseInt(1)}
    addItem(newItem)
  };
  ...
  return(
    <div id="music-content" >
          <div id="album1"  >
            <h3>{product.title}</h3>
            <div className="image-container" onClick={productClickHandler}>
